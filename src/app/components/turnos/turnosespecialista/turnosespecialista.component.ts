...
export class TurnosespecialistaComponent implements OnInit {
  ...
  filtrarPorPaciente(paciente: any) {
    ...
    let arrayAux: any = this.turnosDelEspecialista.filter((element: any) => element.data.paciente == paciente);
  ...
  filtrarPorEspecialidad(item: any) {
    ...
    let arrayAux: any = this.turnosDelEspecialista.filter((element: any) => element.data.especialidad == item);
    this.turnosDelEspecialista = arrayAux;
  }
  ...
  filtrarPacientes() {
    ...
    this.turnosDelEspecialista.forEach((element: any) => {
      pacientes.push(element.pacientes.paciente);
    });

    this.pacientesFiltrados = pacientes.filter((item: any, index: any) => {
      return pacientes.indexOf(item) === index;
    })
  ...
  filtrarEspecialidades() {
    ...
    this.turnosDelEspecialista.forEach((element: any) => {
      especialidades.push(element.especialidades.especialidad);
    });

    this.especialidadesFiltradas = especialidades.filter((item: any, index: any) => {
      return especialidades.indexOf(item) === index;
    })
